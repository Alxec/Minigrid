...
def register_minigrid_envs():
    ...
    register(
        id='MiniGrid-DonutLava-Long-v0',
        entry_point='minigrid.envs:Lava_Donut_Long_Env'
    )


    register(
        id='MiniGrid-DonutLava-Long-neg02-v0',
        entry_point='minigrid.envs:Lava_Donut_Long_Env',
        kwargs={"neg": 0.2}
    )
    ...
    register(
        id='MiniGrid-DonutLava-Long-neg025-v0',
        entry_point='minigrid.envs:Lava_Donut_Long_Env',
        kwargs={"neg": 0.25}
    )
    ...
    register(
        id='MiniGrid-DonutLava-Long-neg03-v0',
        entry_point='minigrid.envs:Lava_Donut_Long_Env',
        kwargs={"neg": 0.3}
    )
    ...
    register(
        id='MiniGrid-DonutLava-Long-neg04-v0',
        entry_point='minigrid.envs:Lava_Donut_Long_Env',
        kwargs={"neg": 0.4}
    )
    ...
    register(
        id='MiniGrid-DonutLava-Long-neg05-v0',
        entry_point='minigrid.envs:Lava_Donut_Long_Env',
        kwargs={"neg": 0.5}
    )
    ...
    register(
        id='MiniGrid-Lava-Maze-neg05-v0',
    ...
    register(
        id='MiniGrid-Lava-Maze-neg05-v1',
        entry_point='minigrid.envs:Lava_Maze',
        kwargs={"size": 19, "neg": 0.5}
    )
    ...
    register(
        id='MiniGrid-Lava-Maze-neg05-v2',
        entry_point='minigrid.envs:Lava_Maze',
        kwargs={"size": 21, "neg": 0.5}
    )
    ...
    register(
        id='MiniGrid-DonutLava-17x17-neg035-v0',
        entry_point='minigrid.envs:LavaDonutEnv_17',
        kwargs={"neg": 0.35}
    )

    register(
        id='MiniGrid-DonutLava-17x17-neg04-v0',
        entry_point='minigrid.envs:LavaDonutEnv_17',
        kwargs={"neg": 0.4}
    )

    register(
        id='MiniGrid-DonutLava-17x17-neg045-v0',
        entry_point='minigrid.envs:LavaDonutEnv_17',
        kwargs={"neg": 0.45}
    )

    register(
        id='MiniGrid-DonutLava-17x17-neg05-v0',
        entry_point='minigrid.envs:LavaDonutEnv_17',
        kwargs={"neg": 0.5}
    )
    ...
    register(
        id="MiniGrid-Maze-simple-v0",
        entry_point="minigrid.envs:Maze",
        kwargs={"wall_three": False, "wall_four": False},
    )

    register(
        id="MiniGrid-Maze-simple-blocked-v0",
        entry_point="minigrid.envs:Maze",
        kwargs={"wall_one": True, "wall_three": False, "wall_four": False},
    )

    register(
        id="MiniGrid-Maze-simple-v1",
        entry_point="minigrid.envs:Maze",
        kwargs={"wall_one": True, "wall_two": False, "wall_three": False, "wall_four": False},
    )
    ...
    register(
        id="MiniGrid-FakeLava-5x5-3x4-v1",
        entry_point="minigrid.envs:FakeLavaEnv",
        kwargs={"roomsize": 5, "max_steps": 200, "gates": False},
    )

    register(
        id="MiniGrid-FakeLava-5x5-3x4-neg02-v0",
        entry_point="minigrid.envs:FakeLavaEnv",
        kwargs={"roomsize": 5, 'neg': 0.2, "max_steps": 200},
    )

    register(
        id="MiniGrid-FakeLava-5x5-3x4-neg021-v0",
        entry_point="minigrid.envs:FakeLavaEnv",
        kwargs={"roomsize": 5, 'neg': 0.21, "max_steps": 200},
    )

    register(
        id="MiniGrid-FakeLava-5x5-3x4-neg022-v0",
        entry_point="minigrid.envs:FakeLavaEnv",
        kwargs={"roomsize": 5, 'neg': 0.22, "max_steps": 200},
    )

    register(
        id="MiniGrid-FakeLava-5x5-3x4-neg023-v0",
        entry_point="minigrid.envs:FakeLavaEnv",
        kwargs={"roomsize": 5, 'neg': 0.23, "max_steps": 200},
    )

    register(
        id="MiniGrid-FakeLava-5x5-3x4-neg024-v0",
        entry_point="minigrid.envs:FakeLavaEnv",
        kwargs={"roomsize": 5, 'neg': 0.24, "max_steps": 200},
    )

    register(
        id="MiniGrid-FakeLava-5x5-3x4-neg025-v0",
        entry_point="minigrid.envs:FakeLavaEnv",
        kwargs={"roomsize": 5, 'neg': 0.25, "max_steps": 200},
    )

    register(
        id="MiniGrid-FakeLava-5x5-3x4-neg026-v0",
        entry_point="minigrid.envs:FakeLavaEnv",
        kwargs={"roomsize": 5, 'neg': 0.26, "max_steps": 200},
    )

    register(
        id="MiniGrid-FakeLava-5x5-3x4-neg027-v0",
        entry_point="minigrid.envs:FakeLavaEnv",
        kwargs={"roomsize": 5, 'neg': 0.27, "max_steps": 200},
    )

    register(
        id="MiniGrid-FakeLava-5x5-3x4-neg028-v0",
        entry_point="minigrid.envs:FakeLavaEnv",
        kwargs={"roomsize": 5, 'neg': 0.28, "max_steps": 200},
    )

    register(
        id="MiniGrid-FakeLava-5x5-3x4-neg029-v0",
        entry_point="minigrid.envs:FakeLavaEnv",
        kwargs={"roomsize": 5, 'neg': 0.29, "max_steps": 200},
    )
    ...
    register(
        id="MiniGrid-FakeLava-5x5-3x4-neg035-v0",
        entry_point="minigrid.envs:FakeLavaEnv",
        kwargs={"roomsize": 5, 'neg': 0.35, "max_steps": 200},
    )

    register(
        id="MiniGrid-FakeLava-5x5-3x4-neg04-v0",
        entry_point="minigrid.envs:FakeLavaEnv",
        kwargs={"roomsize": 5, 'neg': 0.4, "max_steps": 200},
    )

    register(
        id="MiniGrid-FakeLava-Target-5x5-3x4-v0",
        entry_point="minigrid.envs:FakeLavaEnv",
        kwargs={"roomsize": 5, 'target_start': True, "max_steps": 200},
    )

    register(
        id="MiniGrid-FakeLava-Target-5x5-3x4-neg02-v0",
        entry_point="minigrid.envs:FakeLavaEnv",
        kwargs={"roomsize": 5, 'neg': 0.2, 'target_start': True, "max_steps": 200},
    )

    register(
        id="MiniGrid-FakeLava-Target-5x5-3x4-neg04-v0",
        entry_point="minigrid.envs:FakeLavaEnv",
        kwargs={"roomsize": 5, 'neg': 0.4, 'target_start': True, "max_steps": 200},
    )

    register(
        id="MiniGrid-FakeLava-Target-5x5-3x4-neg03-v0",
        entry_point="minigrid.envs:FakeLavaEnv",
        kwargs={"roomsize": 5, 'neg': 0.3, 'target_start': True, "max_steps": 200},
    )

    register(
        id="MiniGrid-FakeLava-Target-5x5-3x4-neg035-v0",
        entry_point="minigrid.envs:FakeLavaEnv",
        kwargs={"roomsize": 5, 'neg': 0.35, 'target_start': True, "max_steps": 200},
    )

    register(
        id="MiniGrid-FakeLava-Target-5x5-3x4-neg025-v0",
        entry_point="minigrid.envs:FakeLavaEnv",
        kwargs={"roomsize": 5, 'neg': 0.25, 'target_start': True, "max_steps": 200},
    )
    ...
    register(
        id="MiniGrid-FakeLava-Target-7x7-3x4-v0",
        entry_point="minigrid.envs:FakeLavaEnv",
        kwargs={"roomsize": 7, 'target_start': True, "max_steps": 250},
    )
    ...
    register(
        id="MiniGrid-FakeLava-Target-9x9-3x4-v0",
        entry_point="minigrid.envs:FakeLavaEnv",
        kwargs={"roomsize": 9, 'target_start': True, "max_steps": 300},
    )

    register(
        id="MiniGrid-FakeLava-5x5-4x4-v0",
        entry_point="minigrid.envs:FakeLavaEnv",
        kwargs={"roomsize": 5, 'roomsv': 4, "max_steps": 250},
    )

    register(
        id="MiniGrid-FakeLava-Target-5x5-4x4-v0",
        entry_point="minigrid.envs:FakeLavaEnv",
        kwargs={"roomsize": 5, 'roomsv': 4, 'target_start': True, "max_steps": 250},
    )

    register(
        id="MiniGrid-FakeLava-7x7-4x4-v0",
        entry_point="minigrid.envs:FakeLavaEnv",
        kwargs={"roomsize": 7, 'roomsv': 4, "max_steps": 300},
    )

    register(
        id="MiniGrid-FakeLava-Target-7x7-4x4-v0",
        entry_point="minigrid.envs:FakeLavaEnv",
        kwargs={"roomsize": 7, 'roomsv': 4, 'target_start': True, "max_steps": 300},
    )

    register(
        id="MiniGrid-FakeLava-9x9-4x4-v0",
        entry_point="minigrid.envs:FakeLavaEnv",
        kwargs={"roomsize": 9, 'roomsv': 4, "max_steps": 400},
    )

    register(
        id="MiniGrid-FakeLava-Target-9x9-4x4-v0",
        entry_point="minigrid.envs:FakeLavaEnv",
        kwargs={"roomsize": 9, 'roomsv': 4, 'target_start': True, "max_steps": 400},
    )
